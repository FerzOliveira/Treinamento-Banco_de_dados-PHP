...
class Cliente{
	...
	function busca($id = false){
		...
		$obj_con = new ConexaoDB;  //chama a conexão com o servidor
	...
	function delete($id){
		...
		//Intrução SQL DELETE - Start
		$sqlDelete = "
		DELETE FROM cliente
		WHERE idCliente =" .$id;
		;
		//Intrução SQL DELETE - End
